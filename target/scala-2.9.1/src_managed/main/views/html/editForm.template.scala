...
"""),_display_(Seq[Any](/*8.2*/main("Editer un evenement")/*8.29*/ {_display_(Seq[Any](format.raw/*8.31*/("""
	...
	<script type="text/javascript" charset="utf-8">
		...
		$("#champ").popover("""),format.raw("""{"""),format.raw/*252.24*/("""title: 'Twitter Bootstrap Popover', content: "It's so simple to create a tooltop for my website!""""),format.raw("""}"""),format.raw/*252.122*/(""");

		function refreshtable()"""),format.raw("""{"""),format.raw/*254.27*/("""
			$('#divtest').load('/KIND/eventEdit/"""),_display_(Seq[Any](/*255.41*/(new sun.misc.BASE64Encoder().encode((event.id.toString).getBytes)))),format.raw/*255.108*/("""/consult/"""),_display_(Seq[Any](/*255.118*/(new sun.misc.BASE64Encoder().encode((event.email).getBytes)))),format.raw/*255.179*/("""/adm #divtest', function(responseText, textStatus, XMLHttpRequest) """),format.raw("""{"""),format.raw/*255.247*/("""styles();$("body").append(responseText);"""),format.raw("""}"""),format.raw/*255.288*/(""");
		"""),format.raw("""}"""),format.raw/*256.4*/("""

		$(function()"""),format.raw("""{"""),format.raw/*258.16*/("""
			$("table.datesTable td").css("background-color", color3);
			$(".checkbox").attr("disabled", "true"); 

			$('.checkbox').each(function (i) """),format.raw("""{"""),format.raw/*262.38*/(""" // coloration des box checkées
			  	if ($(this).is(':checked'))"""),format.raw("""{"""),format.raw/*263.35*/("""
			  		$(this).parent().css("background-color", "#66CC99");
			  	"""),format.raw("""}"""),format.raw/*265.8*/("""
			"""),format.raw("""}"""),format.raw/*266.5*/(""");

			$('.infoPersonne').each(function (i) """),format.raw("""{"""),format.raw/*268.42*/("""
				$('.titres').attr('style','');
				$('.legende').attr('style','');
		...
		adminTools(""""),_display_(Seq[Any](/*282.16*/adm)),format.raw/*282.19*/("""");
		...
		* A trouver dans le fichier sendMail.js*/
		...
		Mails(""""),_display_(Seq[Any](/*290.11*/routes/*290.17*/.Application.sendMail(event.id))),format.raw/*290.48*/("""");
		...
		* complet sur ajoutPersonne.js*/
		...
		AjoutParticipant(""""),_display_(Seq[Any](/*298.22*/routes/*298.28*/.Application.addParticipant(new sun.misc.BASE64Encoder().encode((event.id.toString).getBytes)))),format.raw/*298.122*/("""", """"),_display_(Seq[Any](/*298.127*/adm)),format.raw/*298.130*/("""");
		...
		* a trouver sur ajoutDateHeure.js*/
		...
		ajoutDateHoraire(""""),_display_(Seq[Any](/*306.22*/routes/*306.28*/.Application.addDate(event.id))),format.raw/*306.58*/("""", """"),_display_(Seq[Any](/*306.63*/routes/*306.69*/.Application.newHoraire(event.id))),format.raw/*306.102*/("""", """"),_display_(Seq[Any](/*306.107*/routes/*306.113*/.Application.dateChanged(event.id))),format.raw/*306.147*/("""");


		/* Code concernant la suppression d'horaires et de jours*/
		 
		supprDateHoraire(""""),_display_(Seq[Any](/*311.22*/routes/*311.28*/.Application.deleteHoraire(event.id))),format.raw/*311.64*/("""", """"),_display_(Seq[Any](/*311.69*/routes/*311.75*/.Application.removeDate(event.id))),format.raw/*311.108*/("""");
		

		/*Code sur l'édition des participants
		* A trouver dans le fichier edition.js*/

		editFunctions(""""),_display_(Seq[Any](/*317.19*/routes/*317.25*/.Application.getPass())),format.raw/*317.47*/("""", """"),_display_(Seq[Any](/*317.52*/routes/*317.58*/.Application.updatePersonne(event.id))),format.raw/*317.95*/("""", """"),_display_(Seq[Any](/*317.100*/routes/*317.106*/.Application.checkBoxJour(event.id))),format.raw/*317.141*/("""", """"),_display_(Seq[Any](/*317.146*/routes/*317.152*/.Application.checkBoxHoraire(event.id))),format.raw/*317.190*/("""");
		...
		* A trouver dans le fichier suppression.js*/
		...
		Delete(""""),_display_(Seq[Any](/*324.12*/routes/*324.18*/.Application.getPass())),format.raw/*324.40*/("""", """"),_display_(Seq[Any](/*324.45*/routes/*324.51*/.Application.deleteParticipant(event.id))),format.raw/*324.91*/("""")



		/*Code sur les participants obligatoires*/
		partobligatoire(""""),_display_(Seq[Any](/*329.21*/routes/*329.27*/.Application.changeObligatoire(event.id))),format.raw/*329.67*/("""");
