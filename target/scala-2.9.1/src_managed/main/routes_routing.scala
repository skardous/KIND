...
// @LINE:48
val controllers_Application_addMail25 = Route("POST", PathPattern(List(StaticPart("/KIND/eventEdit/"),DynamicPart("id", """[^/]+"""),StaticPart("/addMail"))))
                    

// @LINE:50
val controllers_Application_getPass26 = Route("POST", PathPattern(List(StaticPart("/KIND/eventEdit/"))))
...
// @LINE:48
case controllers_Application_addMail25(params) => {
   call(params.fromPath[Long]("id", None)) { (id) =>
...
// @LINE:50
case controllers_Application_getPass26(params) => {
   call { 
